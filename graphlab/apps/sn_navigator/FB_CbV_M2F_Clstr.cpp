...
struct vdata {
     ...
     vdata() :
                friends(), att_names(), att_values(), att_v_n_freq(), att_group(),freq(), att_group_clstr(),freq_clstr(), is_centroid(false),CAG_supp() {}

      explicit vdata(std::vector<graphlab::vertex_id_type> f,std::vector< std::string> a_n, std::multimap<std::string, std::string> a_v,  bool isc) :
               friends(f),att_names(a_n), att_values(a_v), att_v_n_freq(), att_group(),freq(), att_group_clstr(),freq_clstr(), is_centroid(isc) ,CAG_supp() {}
...
std::vector<graphlab::vertex_id_type> getRandomCent( graphlab::vertex_id_type vid ){
   ...
   //10//
   //centroids.insert(std::make_pair(595587084, 525476270));
   //centroids.insert(std::make_pair(595587084, 543902003));
   centroids.insert(std::make_pair(595587084, 525476270));
   //16//
   //centroids.insert(std::make_pair(687892729, 13611296));
   //centroids.insert(std::make_pair(687892729, 525476270));
   centroids.insert(std::make_pair(687892729, 543902003));
   //1//
   //centroids.insert(std::make_pair(1019578116, 543902003));
   centroids.insert(std::make_pair(1019578116, 555825818));
   centroids.insert(std::make_pair(1019578116, 659229259));
   //3//
   //centroids.insert(std::make_pair(13611296, 525476270));
   centroids.insert(std::make_pair(13611296, 525476270));
   centroids.insert(std::make_pair(13611296, 543733258));
   //17//
   //centroids.insert(std::make_pair(721547651, 13611296));
   //centroids.insert(std::make_pair(721547651, 525476270));
   centroids.insert(std::make_pair(721547651, 595587084));
   //5//
   //centroids.insert(std::make_pair(525476270, 13611296));
   centroids.insert(std::make_pair(525476270, 543733258));
   centroids.insert(std::make_pair(525476270, 595587084));
   //8//
   centroids.insert(std::make_pair(555825818, 1019578116));
   centroids.insert(std::make_pair(555825818, 525476270));
   centroids.insert(std::make_pair(555825818, 543733258));
   //18//
   centroids.insert(std::make_pair(775333694, 13611296));
   centroids.insert(std::make_pair(775333694, 543733258));
   centroids.insert(std::make_pair(775333694, 555825818));
   //6//
   centroids.insert(std::make_pair(543733258, 1019578116));
   centroids.insert(std::make_pair(543733258, 13611296));
   centroids.insert(std::make_pair(543733258, 525476270));
   //14//
   centroids.insert(std::make_pair(656597045, 13611296));
   centroids.insert(std::make_pair(656597045, 525476270));
   centroids.insert(std::make_pair(656597045, 543733258));
   //15//
   centroids.insert(std::make_pair(659229259, 1019578116));
   centroids.insert(std::make_pair(659229259, 555825818));
   //centroids.insert(std::make_pair(659229259, 721547651));
   //7//
   //centroids.insert(std::make_pair(543902003, 1019578116));
   //centroids.insert(std::make_pair(543902003, 13611296));
   centroids.insert(std::make_pair(543902003, 687892729));
   //19//
   centroids.insert(std::make_pair(780219903, 13611296));
   centroids.insert(std::make_pair(780219903, 525476270));
   centroids.insert(std::make_pair(780219903, 543733258));
...
size_t getIntraConnCount ( graphlab::vertex_id_type vid ){
   ...
   centroids[1019578116] = 2;
   centroids[721547651] = 1;
   centroids[780219903] = 3;
   centroids[615038675] = 1;
   centroids[1034232372] = 1;
   centroids[1448183152] = 0;
   centroids[775333694] = 2;
   centroids[543733258] = 2;
   centroids[610148917] = 1;
   centroids[687892729] = 1;
   centroids[656597045] = 4;
   centroids[659229259] = 5;
   centroids[651308035] = 0;
   centroids[595587084] = 6;
   centroids[555825818] = 4;
   centroids[543902003] = 2;
   centroids[588672869] = 1;
   centroids[13611296] = 3;
   centroids[525476270] = 2;
        ...
        if(context.iteration() == 0){
           ...
           //add final aggregation on discovered CAG
            ...
            /*for(size_t index=0; index < vertex.data().freq.size(); index ++){
                vertex.data().freq[index] /= vertex.data().friends.size();
...
bool line_parser(graph_type& graph,
                   ...
                   const std::string& textline)
 {
    ...
    bool isCent = false, loadmiss = false;
    std::vector<std::string> att_names;
    std::multimap<std::string, std::string>  att_values;
...
/////////////////////////////////////////////////Load data    
  ...
  //}
   ...
   //if((wht2load>20 && wht2load<=30) || (more2load>20 && more2load<=30)){
...
///////////////////////////////////////////Add node to the graph
    graph.add_vertex(vid, vdata(frnds,att_names,att_values,isCent));
    if(isCent)
  ...
  std::string save_vertex(graph_type::vertex_type v) {
        ...
        if(isCentroid(v.id())){
         ...
         for(size_t i=0; i< v.data().att_group.size(); i++)
             ...
             strm <<  v.data().att_group[i]  <<","  << v.data().CAG_supp[i] << "\n";
         /*strm << "************************ \n";
